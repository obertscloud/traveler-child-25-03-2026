...
<?php
$tour_id     = get_the_ID();
$price_by    = get_post_meta($tour_id, 'tour_price_by', true);
$adult_price = floatval(get_post_meta($tour_id, 'adult_price', true));
$base_price  = floatval(get_post_meta($tour_id, 'base_price', true));
...
$price_html = TravelHelper::format_money($final_price);

echo wp_kses(
    ' <span class="price d-flex align-content-end flex-column">' . $price_html . '</span>'
